...
function showButtons(context, buttonsConfig, isStack) {
    if (buttonsConfig) {
        ...
        if (buttonsConfig['ghcid'] === true ||  buttonsConfig['ghcid'] === undefined) {
            buttons.push(['Launch GHCid', 'editor.ghcid']);
        }
        ...
        if (isStack) {
            createButtons(context, [['Launch GHCid', 'editor.ghcid'], ['Load GHCi', 'editor.ghci'], ['Stack Build', 'editor.stackBuild'],
            ['Stack Run', 'editor.stackRun'], ['Stack Test', 'editor.stackTest']]);
        } else {
            createButtons(context, [['Launch GHCid', 'editor.ghcid'], ['Load GHCi', 'editor.ghci'],
